...
import { getSiteTasks, updateSiteTaskStatus } from '../../../api/siteApi';
...
const SiteTasks = () => {
  ...
  const handleStatusChange = async (taskId, newStatus) => {
    try {
      await updateSiteTaskStatus(taskId, { status: newStatus });
  ...
  return (
    <div>
      <PageHeader title="My Site Tasks" subtitle="Tasks assigned to you by the Project Manager or System">
      ...
      <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.04)', border: '1px solid #f1f5f9' }}>
        ...
        {loading ? (
          ...
          <EmptyState icon={FaTasks} title="No tasks found" message="You don't have any site tasks matching this filter." />
        ) : (
